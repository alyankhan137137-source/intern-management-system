...
class AppRepository {
  ...
  final List<MessageModel> _messages = [
    MessageModel(id: '1', senderName: 'Sarah Wilson', content: 'Hey! How is the UI refactor going?', timestamp: DateTime.now().subtract(const Duration(minutes: 30)), isMe: false),
    ...
    MessageModel(id: '3', senderName: 'Sarah Wilson', content: 'Perfect. Let me know if you need help with the charts.', timestamp: DateTime.now().subtract(const Duration(minutes: 20)), isMe: false),
  ];
  ...
  final List<MentorFeedback> _feedback = [
    MentorFeedback(id: 'f1', mentorName: 'Sarah Wilson', comment: 'Excellent progress on the UI refactor. The attention to detail is impressive.', rating: 4.8, date: DateTime.now().subtract(const Duration(days: 3))),
    MentorFeedback(id: 'f2', mentorName: 'Sarah Wilson', comment: 'Good start on the documentation. Try to be more concise in the API section.', rating: 4.2, date: DateTime.now().subtract(const Duration(days: 10))),
  ];
  ...
  final List<NotificationModel> _notifications = [
    ...
    NotificationModel(id: 'n2', title: 'Feedback Received', message: 'Sarah Wilson left a new feedback on your performance.', timestamp: DateTime.now().subtract(const Duration(days: 3))),
  ];
